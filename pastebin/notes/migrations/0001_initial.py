...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='note',
            name='user_stars',
            field=models.ManyToManyField(related_name='starred_notes', through='notes.UserStars', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='meta_data', to='notes.comment')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
